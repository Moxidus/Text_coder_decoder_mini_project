...
class PerformanceEvaluator:
    ...
    * Coded file size vs original file size (overhead)
    * Decode success/failure indicator (and any additional metric you propose)
    * A minimum recommended metric is File Expansion Ratio (FER):
